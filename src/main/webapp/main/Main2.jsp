...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/main_style.css">
    <script src="${pageContext.request.contextPath}/static/js/game.js"></script> <!-- 외부 스크립트 파일 연결 -->
</head>
<body>
...
<div class="container">
    <div class="food-item">
        <input type="image" id="image1" src="${pageContext.request.contextPath}/static/images/<%= selectedImages[0] %>">
    </div>

    <div class="vs-text">VS</div>

    <div class="food-item">
        <input type="image" id="image2" src="${pageContext.request.contextPath}/static/images/<%= selectedImages[1] %>">
    </div>
</div>
</main>
