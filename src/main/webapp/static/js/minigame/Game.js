...
function nextRound() {
    if (selectedImages.length >= 2) {
        ...
        // 이미지 업데이트
        document.getElementById('image1').src = '${pageContext.request.contextPath}/static/images/minigame/' + currentPair[0];
        document.getElementById('image2').src = '${pageContext.request.contextPath}/static/images/minigame/' + currentPair[1];
