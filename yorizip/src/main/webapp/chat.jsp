...
<body>
    <!-- 모달 열기 이미지 -->
    <img src="resources/images/Group 252.png" alt="모달 열기 이미지" class="open-modal-img">

    <!-- 모달 오버레이 및 컨테이너 -->
    <div class="modal-overlay">
        <div class="modal-container">
            <div class="modal-header">
                <img src="resources/images/Group 290.png" alt="YORI:ZIP 로고">
                <div>
                    <h2>YORI:ZIP</h2>
                    <h4>운영시간 보기 ></h4>
                </div>
            ...
            <!-- 네비게이션바 -->
           <div class="nav_bar">
           <img src="resources/images/homeicon.png" alt="YORI:ZIP 로고" onclick="location.">
           
           </div>
           <div class="nav_bar2">
           <img src="resources/images/chaticon.png" alt="YORI:ZIP 로고">
           
           </div><div class="nav_bar3">
           <img src="resources/images/seticon.png" alt="YORI:ZIP 로고">
